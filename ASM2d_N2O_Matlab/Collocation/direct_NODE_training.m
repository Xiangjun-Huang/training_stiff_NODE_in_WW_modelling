...
% Same Neural ODE Model
% Same function |odeModel used in collocation training|, which takes as input 
% the time input (unused), the corresponding solution, and the ODE function parameters. 
% The function applies a fully connected operation, a tanh operation, and another 
...
for iter = 1:numIter
    ...
    % Create batch 
    [X, targets] = createMiniBatch_NODE(numTrainingTimesteps, neuralOdeTimesteps, miniBatchSize, coll_y);
